...
class demo_net(nn.Module):
    ...
    def history_gate_unit(self, patient_rep, all_vst_drug, contacter):
        ...
        his_seq_enhance = his_seq_filter_mask * his_seq_container
    ...
    def decoder(self,drug_mem=None,patient_rep=None,ccs_patient_rep=None):
        ...
        his_enhance = self.history_gate_unit(patient_rep=patient_rep,all_vst_drug=drug_mem,contacter=self.patient_mem_contact)
        #============================================================
        # +++++++++++++++++++++++++++++++++++++++++++++
        ccs_patient_rep = ccs_patient_rep.squeeze(dim=1)
        ccs_his_enhance = self.history_gate_unit(patient_rep=patient_rep, all_vst_drug=drug_mem,
                                                 contacter=self.patient_mem_contact)
        # ============================================================
